...
Rails.application.config.assets.precompile += %w( trackings/app.js )
Rails.application.config.assets.precompile += %w( ico.css )
Rails.application.config.assets.precompile += %w( ico/base.js )